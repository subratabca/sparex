<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="{{ url('/restaurant/dashboard') }}" class="app-brand-link">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->routeIs('client.dashboard') ? 'active' : '' }}">
      <a href="{{ url('/restaurant/dashboard') }}" class="menu-link">
    ...
    <li class="menu-item {{ request()->routeIs(['client.meal.orders*','client.meal.reports*']) ? 'active open' : '' }}">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item {{ request()->routeIs('client.meal.reports*') ? 'active' : '' }}">
          <a href="{{ route('client.meal.reports') }}" class="menu-link">
