...
<div class="authentication-inner row m-0">
  ...
  <div class="w-px-400 mx-auto pt-5 pt-lg-0">
    ...
    <h4 class="mb-2">Client, Welcome to <span id='auth-page-website-name'></span> 👋</h4>
  ...
  async function SubmitLogin() {
    ...
    if (email.length === 0) {
      ...
      try {
        ...
        let res = await axios.post("/restaurant/login", { email: email, password: password, remember: remember });
