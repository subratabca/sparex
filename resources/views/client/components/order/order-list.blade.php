        ...
        try {
            ...
            if (res.status === 200 && res.data.status === 'success') {
                ...
                res.data.data.forEach(function (item, index) {
                    ...
                    let deliveryType = item.order.delivery_type ? item.order.delivery_type.charAt(0).toUpperCase() + item.order.delivery_type.slice(1) : '-';

                    let paymentType = item.order.payment_type ? item.order.payment_type.charAt(0).toUpperCase() + item.order.payment_type.slice(1) : '-';
                    ...
                    let row = `
                        <tr>
                            ...
                            <td>
                                ...
                                <button data-id="${item.order_id}" class="btn deleteBtn btn-sm btn-outline-danger" title="Orde Delete">
