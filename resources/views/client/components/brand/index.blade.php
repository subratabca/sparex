<div class="card">
    <div class="card-header header-elements">
        ...
        <div id="addNewButtonContainer" class="card-header-elements ms-auto">
            <a href="/restaurant/create/brand" type="button" class="btn btn-primary waves-effect waves-light">
...
<script>
    ...
    async function getList() {
        showLoader();
        try {
            let res = await axios.get("/restaurant/brand/list");
            ...
            res.data.data.forEach(function (item, index) {
                let row = `
                    <tr>
                        ...
                        <td>${item['name']}</td>
                        <td>
                            <a href="/restaurant/edit/brand/${item['id']}" class="btn btn-sm btn-outline-success"><span class="mdi mdi-pencil-outline"></span></a>
