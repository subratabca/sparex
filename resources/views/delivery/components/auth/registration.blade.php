...
<div class="authentication-inner row m-0">
  ...
  <div class="w-px-400 mx-auto pt-5 pt-lg-0">
    ...
    <h4 class="mb-2">Delivery - Adventure starts here at <span id='auth-page-website-name'></span> 🚀</h4>
      ...
      <div class="mb-3">
        <div class="form-check">
          ...
          <label class="form-check-label" for="terms-conditions">
            I agree to
            <a href="/delivery/registration/terms-conditions/delivery_registration" target="_blank">privacy policy & terms</a>
          </label>
        </div>
    ...
    <p class="text-center mt-2">
      ...
      <a href="{{ route('delivery.login.page') }}">
...
<script>
  async function Registration() {
    ...
    if(email.length === 0){
      ...
      try {
        let res = await axios.post("/delivery/registration", {
          email: email,
          firstName: firstName,
          password: password,
