...
<div class="authentication-inner row m-0">
  ...
  <div class="w-px-400 mx-auto pt-5 pt-lg-0">
    ...
    <h4 class="mb-2">Delivery, Welcome to <span id='auth-page-website-name'></span> 👋</h4>
    ...
    <form id="formAuthentication" class="mb-3">
      ...
      <div class="mb-3 d-flex justify-content-between">
        ...
        <a href="{{ url('/rider/sendOtp') }}" class="float-end mb-1">
    ...
    <p class="text-center mt-2">
      ...
      <a href="{{ route('delivery.registration.page') }}">
  ...
  async function SubmitLogin() {
    ...
    if (email.length === 0) {
      ...
      try {
        ...
        let res = await axios.post("/rider/login", { email: email, password: password, remember: remember });
