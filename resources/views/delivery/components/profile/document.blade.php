...
async function DocDetailsInfo() {
  ...
  try {
      ...
      if (response.status === 200) {
        ...
        document.getElementById('docImg1').src = userData['doc_image1'] ? "/upload/delivery-document/small/" + userData['doc_image1'] : "/upload/no_image.jpg";

        document.getElementById('docImg2').src = userData['doc_image2'] ? "/upload/delivery-document/small/" + userData['doc_image2'] : "/upload/no_image.jpg";
...
async function onDocumentUpdate(event) {
    ...
    if (firstName.length === 0) {
        ...
        try {
            let res = await axios.post("/delivery/store/document/info", formData, config);
