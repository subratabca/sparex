        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="formAccountSettings">
                    ...
                    <hr>
                    <p class="mb-4"><span class="text-danger">You must upload any of 2 documens</span> (Passport/NID/Bank Statement,Driving license is must)</p>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <div class="button-wrapper">
                                    <label for="image2" class="btn btn-primary me-2 mb-3" tabindex="0">
                                        <span class="d-none d-sm-block">Upload Driving License</span>
                                        <i class="mdi mdi-tray-arrow-up d-block d-sm-none"></i>
...
// ===== Load delivery profile + populate the form =====
    ...
    try {
        ...
        if (response.status === 200) {
            ...
            document.getElementById('docImg1').src = userData['doc_image1']
                ? (isPdfName(userData['doc_image1']) ? PDF_ICON : "/upload/delivery-document/small/" + userData['doc_image1'])
                : "/upload/no_image.jpg";
            document.getElementById('docImg2').src = userData['doc_image2']
                ? (isPdfName(userData['doc_image2']) ? PDF_ICON : "/upload/delivery-document/small/" + userData['doc_image2'])
                : "/upload/no_image.jpg";
...
async function onDocumentUpdate(event) {
    ...
    if (firstName.length === 0) {
        ...
        document.getElementById('image2-error').innerText = 'Driving license is required!.';
    } else {
        ...
        try {
            showLoader();
            const res = await axios.post("/rider/store/document/info", formData, {
