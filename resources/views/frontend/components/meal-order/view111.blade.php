    ...
    <div class="card shadow-sm border-0 mt-3">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                <div>
                    <p class="mb-0 text-muted">Meal Date: <span id="orderDateText"></span></p>
                </div>
                <div>
...
async function loadMealOrderDetails(orderId) {
    ...
    try {
        ...
        if (res.status === 200 && res.data.status === 'success') {
            ...
            const caloriesByMealType = res.data.calories_by_meal_type;
            const groupedItems = groupByMealType(order.items);

            document.getElementById('orderDateText').textContent = order.order_date;
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-0 shadow-sm h-100 hover-card">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <h6 class="fw-bold text-dark text-center">${item.product?.name || 'Unnamed Product'}</h6>
