                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Get personalised meal suggestions based on your profile and past orders.
                        </p>
                    </div>
                </div>
        ...
        <div class="card-header bg-white border-0 pt-4 pb-0">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                <h5 class="fw-bold mb-0">
                    <i class="mdi mdi-food-fork-drink me-2 text-primary"></i>Browse Meals
                </h5>
        ...
        <div class="card-body">
            ...
            <div id="keyword-section" class="bg-light rounded-3 p-3 mb-4" style="display:none;">
                <h6 class="fw-bold mb-2">
                    <i class="mdi mdi-tag-multiple-outline me-1"></i>Filter by Keywords
                </h6>
        ...
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-gradient-primary text-white">
                <h5 class="modal-title fw-semibold">
                    <i class="mdi mdi-clipboard-pulse-outline me-2"></i>Smart Meal Planner
                </h5>
            ...
            <div class="modal-body p-4">
                ...
                <div id="ai-form-section">
                    <p class="text-muted mb-4">
                        Tell us about yourself and we'll suggest meals for next week based on your
                        health profile and ordering history.
                    </p>
                    <div class="row g-3">
                        <div class="col-md-6">
...
/* ===================== SMART MEAL PLANNER (history-based) ===================== */
...
async function generateAiPlan() {
    ...
    try {
        const res = await axios.post('/user/generate/meal-suggestion', {
            gender, age, weight, height, description, period
        });
