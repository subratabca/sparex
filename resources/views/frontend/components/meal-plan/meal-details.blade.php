...
<div class="card">
    <div class="card-header header-elements">
        <span class="me-2"><h5>Meal Details Information</h5></span>
        <div class="card-header-elements ms-auto">
            <a href="{{ route('meal.plan') }}" type="button" class="btn btn-primary waves-effect waves-light">
                <span class="tf-icon mdi mdi-arrow-left me-1"></span>Back To Meal List
            </a>
        </div>
    </div>
    <div class="card-body">
...
async function mealDetailsInfo() {
    showLoader();
    try {
