...
<div class="card mb-4">
<h5 class="card-header">Update Password</h5><hr style="margin:0;padding:0">
<div class="card-body">
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    document.getElementById('formAccountSettings').addEventListener('submit', onUpdate);
  });
  ...
  async function onUpdate(event) {
    ...
    if (oldpassword.length === 0) {
      ...
      try {
        let res = await axios.post("/password/update", {
