...
<head>
    ...
    <title>@yield('title', 'SpareX')</title>
    ...
    <link rel="icon" type="image/x-icon"
          href="{{ asset('frontend/assets/img/favicon/favicon.ico') }}" />
    ...
    <!-- Icons -->
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/fonts/materialdesignicons.css') }}" />
    <link rel="stylesheet"
    ...
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/swiper/swiper.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/quill/typography.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/quill/katex.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/quill/editor.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/typeahead-js/typeahead.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css') }}" />
    <link rel="stylesheet"
          href="{{ asset('frontend/assets/vendor/libs/datatables-rowgroup-bs5/rowgroup.bootstrap5.css') }}" />
    ...
    <!-- Template helpers only — no config.js here -->
...
<body>
    <!-- Dropdown helpers — before header -->
    ...
    <!-- ===== Loader — must be in DOM before config.js runs ===== -->
