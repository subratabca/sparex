<div class="card">
    <div class="card-header header-elements">
        <span class="me-2"><h5>Hero Information</h5></span>
        <div id="addNewButtonContainer" class="card-header-elements ms-auto">
            <a href="/admin/create/hero" type="button" class="btn btn-primary waves-effect waves-light">
...
<script>
    ...
    async function getList() {
        showLoader();
        try {
            let res = await axios.get("/admin/hero/list");
            ...
            res.data.data.forEach(function (item, index) {
                ...
                let row = `
                    <tr>
                        <td>1</td>
                        <td>${item['image'] ? `<img src="/upload/hero/${item['image']}" width="150" height="100">` : `<img src="/upload/no_image.jpg" width="80" height="50">`}</td>
                        <td>${item['title']}</td>
                        <td>${limitedDescription}........</td>
                        <td>
                            <a href="/admin/edit/hero/${item['id']}" class="btn btn-sm btn-outline-success"><span class="mdi mdi-pencil-outline"></span></a>
