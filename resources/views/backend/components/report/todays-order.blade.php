        ...
        try {
            ...
            if (res.status === 200) {
                ...
                res.data.data.forEach(function (item, index) {
                    ...
                    let paidAmount = item.payable_amount !== null ? `£${parseFloat(item.paid_amount).toFixed(2)}` : '-';
                    ...
                    let row = `
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="/admin/order/details/${item.id}" class="btn btn-sm btn-outline-primary"><span class="mdi mdi-eye-circle" title="Order Details"></span>
                            </a>
                          </td>
                        </tr>
                    `;
