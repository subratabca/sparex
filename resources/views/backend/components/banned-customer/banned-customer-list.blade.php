...
<script>
    ...
    async function getList() {
        showLoader();
        try {
            let res = await axios.get("/admin/get/banned/customers");
                   ...
                   let customerName = item.customer.lastName ? `${item.customer.firstName} ${item.customer.lastName}` : item.customer.firstName;
                    ...
                    let row = `
                        <tr>
                            ...
                            <td>${complainTime}</td>
                            <td>
                                <a  href="/admin/banned/customer/details/${item.id}" class="btn btn-sm btn-outline-primary" title="Banned customer details"><span class="mdi mdi-eye-circle"></span>
                                </a>
                            </td>
                        </tr>`;
