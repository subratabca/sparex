                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm hover-card">
                            <div class="card-header bg-light">
                                <h6 class="mb-0"><i class="mdi mdi-account-circle me-2"></i>Client Information</h6>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        <img id="clientImage" src="/upload/no_image.jpg" alt="Client" class="rounded-circle" style="width: 70px; height: 70px; object-fit: cover;">
                                    </div>
                                    <div>
                                        <h5 class="mb-1" id="clientName">Loading...</h5>
                                        <p class="mb-1 text-muted" id="clientEmail">Email: Loading...</p>
                                        <p class="mb-0 text-muted" id="clientPhone">Phone: Loading...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
async function loadClientPaymentDetails() {
    try {
        ...
        // Match the pattern: /admin/meal/payment/details/client/{clientId}/order/{orderId}
        ...
        console.log('Extracted IDs:', { clientId, orderId });
        
        const response = await axios.get(`/admin/get/meal/payment/details/by/client/${clientId}/order/${orderId}`);
...
function updateClientInfo(client) {
    ...
    if (client.image) {
        document.getElementById('clientImage').src = `/upload/client-profile/small/${client.image}`;
    }
}
