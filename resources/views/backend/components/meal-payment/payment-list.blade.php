...
async function getList() {
    showLoader();
    try {
        let res = await axios.get("/admin/get/meal/payments");
            ...
            res.data.data.forEach(function (item, index) {
                ...
                let row = `
                    <tr>
                        ...
                        <td>${orderDate}</td>
                        <td>
                            <a href="/admin/meal-order/details/${item.order_id}" class="text-primary text-decoration-underline" target="_blank">${invoiceNo}</a>
                        </td>
                        <td>${clientName}</td>
                        <td>${payableAmount}</td>
