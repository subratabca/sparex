...
<script>
    ...
    async function getList() {
        showLoader();
        try {
            let res = await axios.get("/get/meal-types");
                ...
                res.data.data.forEach(function (item, index) {
                    ...
                    let row = `
                        <tr>
                            ...
                            <td>${mealTypeName}</td>
                            <td>
                                <a href="/admin/edit/meal-type/${item['id']}" class="btn btn-sm btn-outline-success" title="Edit Product"><span class="mdi mdi-pencil-outline"></span>
                                </a>
