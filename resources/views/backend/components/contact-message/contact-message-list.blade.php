...
<script>
    ...
    async function getList() {
        showLoader();
        try {
            let res = await axios.get("/admin/contact-message/list/info");
            ...
            res.data.data.forEach(function (item, index) {
                ...
                let row = `
                    <tr>
                        ...
                        <td>
                            <a  href="/admin/contact-message/details/${item['id']}" class="btn btn-sm btn-outline-primary"><span class="mdi mdi-eye-circle"></span>
                            </a>
