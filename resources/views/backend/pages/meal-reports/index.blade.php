...
async function loadSummary() {
    try {
        ...
        document.getElementById('kpi-client-platform-fee').textContent  = '£' + d.total_client_platform_fee;
        document.getElementById('kpi-rider-platform-fee').textContent   = '£' + d.total_rider_platform_fee;
        document.getElementById('kpi-net-profit').textContent           = '£' + d.net_profit;
