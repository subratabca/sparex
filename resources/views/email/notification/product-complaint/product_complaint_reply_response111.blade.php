        ...
        <div style="background: #fff8e1; border-left: 4px solid #ffc107; padding: 15px; margin-bottom: 25px; border-radius: 4px;">
                @if($recipientType === 'admin')
                    <p style="margin: 0; color: #2e7d32; font-weight: 500;">
                        The {{ $senderRole }} has responded to the complaint for <strong>Order #{{ $complaint->order->order_number }}</strong>.
                    </p>
                ...
                @else
                    @if($senderRole === 'seller')
                        <p style="margin: 0; color: #2e7d32; font-weight: 500;">
                            The seller has provided the response regarding your complaint for <strong>Order #{{ $complaint->order->order_number }}</strong>.If this response resolves your concern, no further action is needed.
                        </p>
                    ...
                    @else
                        <p style="margin: 0 0 10px 0; color: #2e7d32; font-weight: 500;">
                           The customer has provided the response regarding his complaint for <strong>Order #{{ $complaint->order->order_number }}</strong>.By clicking below link you can see complaint details.
                        </p>
                    @endif
