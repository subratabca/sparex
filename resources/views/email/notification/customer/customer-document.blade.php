...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>{{ $customer->firstName }}{{ isset($customer->lastName) ? ' ' . $customer->lastName : '' }} has submitted required documents and needs approval. Below are the customer details:</p>
            
            <div class="customer-details">
                <div class="detail-row">
                    <span class="detail-label">Customer Name:</span>
                    <span class="detail-value">{{ $customer->firstName }}{{ isset($customer->lastName) ? ' ' . $customer->lastName : '' }}</span>
                </div>
                <div class="detail-row">
