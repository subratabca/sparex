...
class ForwardProductComplaintNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                ...
                ->view('email.notification.product-complaint.admin_forwarded_product_complaint', compact('complaint','recipientType'))
