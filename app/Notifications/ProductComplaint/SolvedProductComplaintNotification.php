...
class SolvedProductComplaintNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                ...
                ->view('email.notification.product-complaint.solved_product_complaint', compact('complaint','recipientType'))
