...
use App\Notifications\Product\ProductPublishNotification;
...
class AdminProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            ActivityLogger::log('retrieve_item_failed','Failed to retrieve products. Error: ' . $e->getMessage(),$request,'products');
            return response()->json([
                'status' => 'failed',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $admin->notify(new ProductUploadNotification($product->load('client')));
    ...
    public function productPublish(Request $request)
    {
        try {
            ...
            foreach ($customers as $customer) {
                $customer->notify(new ProductPublishNotification($product, $publishDate));
            }
